...
class Tags extends React.Component<TagsProps, any> {
  render() {
    if (this.props.type == 'sugg') {
      ...
      return this.props.tags.map((d: any, i: number) => (
        <View key={i} style={[styles.container, this.props.style]}>
          <Text style={styles.tagsText}>{d.email}</Text>
          <TouchableOpacity
            onPress={() => this.props.onClose(d)}
            style={styles.containerIcon}>
            <Icon
    ...
    } else if (this.props.type == 'organizationPeoplesSuggestioms') {
      return this.props.tags.map((d: any, i: number) => (
        <View key={i} style={[styles.container, this.props.style]}>
          <Text style={styles.tagsText}>{d}</Text>
          <TouchableOpacity
    ...
    } else if (this.props.type == 'tagsofEsclatedToinvIewSor') {
      return this.props.tags.map((d: any, i: number) => (
        <View key={i} style={[styles.container, this.props.style]}>
          <Text style={styles.tagsText}>{d}</Text>
          <TouchableOpacity
    ...
    } else if (this.props.type == 'esclatedTotags') {
      return (
        <>
          {this.props.tags != undefined && (
            <>
              {this.props.tags?.map((d: any, i: number) => (
                <View key={i} style={[styles.container, this.props.style]}>
                  <Text style={styles.tagsText}>{d}</Text>
                  <TouchableOpacity
                    onPress={() => this.props.onClose(d)}
