...
const Preview = (props: ViewAllProps) => {
  const [sor_type, setsor_type] = useState('concerm');
  ...
  useEffect(() => {
    ...
    createApi
      ...
      .then((user: any) => {
        setcreatedByName(user.data.data.name);
        getCurrentProject().then((currentProj: any) => {
          ...
          createApi
            ...
            .then((res: any) => {
              ...
              getAllAttachments(props.route.params.data.attachments);
            });
        });
      });
  ...
  const printSor = async () => {
    ...
    margin-top: 13px;
    margin-left: 4px;"class="p2 ft2">Project ID: ${projectId}</P>
    <TABLE cellpadding=0 cellspacing=0 class="t0">
    <TR>
      <TD  class="tr0 td0"><P style="    font-size: 15px;
        font-weight: bold;" class="p3 ft3">Project:</P></TD>
      <TD class="tr0 td1"><P class="p3 ft4">${projectName}</P></TD>
    ...
    <TR>
      ...
      <TD class="tr1 td1"><P class="p3 ft4">${moment(
        props.route.params.data.occurred_at,
      ).format('llll')}</P></TD>
    ...
    <P style="font-size: 14px;" class="p5 ft7">On ${moment(
      props.route.params.data.occurred_at,
    ).format('llll')} ${props.route.params.data.details}</P>
    ...
    <TR>
      ...
      <TD class="tr0 td9"><P style="font-size: 16px;"  class="p6 ft8">${
        props.route.params.data.sor_type
      }</P></TD>
    ...
    <TR>
      <TD class="tr3 td8"><P style="font-size: 14px;" class="p3 ft3">Potential Risk:</P></TD>
        ...
        <TD style="font-size: 12px;" rowspan=2 class="tr4 td9">
          ...
          border-radius: 24px;">
           ...
           ${prisk < 6 ? 'low' : prisk < 14 ? 'Medium' : 'High'}
      ...
      <TD style="font-size: 12px;" rowspan=2 class="tr4 td10">
        ...
        border-radius: 24px;">
          ...
          font-size: 14px;
          text-align: center;" class="p3 ft9">
          ${risk < 6 ? 'low' : risk < 14 ? 'Medium' : 'High'}</P>
        </div>
    ...
    ${props.route.params.data.action_required.map(
      (d, i) =>
  ...
  <P class="p5 ft2"><SPAN class="ft2"></SPAN><SPAN class="ft11">${
    props.route.params.data.justification[0].keyFindings
  }</SPAN></P>
...
`
    ...
    ${
      props.route.params.data.attachments.length != 0
        ? `
      ${props.route.params.data.attachments.map(
        (d: any, i: number) =>
  ...
  // get All Attachments
  const getAllAttachments = (attach: any) => {
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.content}>
          ...
          <View
            ...
            <View
              ...
              <Text
                ...
                {moment(props.route.params.data.occured_at).format(
                  'MMM DD, YYYY LT',
                )}
              </Text>
            </View>
          ...
          <View style={{padding: wp(3)}}>
            <Text style={{fontSize: wp(4), fontFamily: fonts.SFuiDisplayBold}}>
              Observation Details
            </Text>
            {/* Date  */}
            <Text style={{fontSize: wp(3), fontFamily: fonts.SFuiDisplayLight}}>
            ...
            <View style={{marginTop: wp(2)}}>
              ...
              <View style={{flexDirection: 'row'}}>
                ...
                <View
                  ...
                  <TouchableOpacity style={styles.classittleicon}>
                    {props.route.params.data.sor_type != 'lsr' ? (
                      <View>
                        {props.route.params.data.sor_type != 'near miss' ? (
                          <Icon
                            ...
                            name={
                              props.route.params.data.sor_type == 'lsr'
                                ? 'aperture'
                                : props.route.params.data.sor_type == 'positive'
                                ? 'check-circle'
                                : props.route.params.data.sor_type == 'concern'
                                ? 'warning'
                                : props.route.params.data.sor_type ==
                                  'near miss'
                                ? 'centercode'
                    ...
                    <Text
                      ...
                      {capitalizeFirstLetter(props.route.params.data.sor_type)}
                    </Text>
                  </TouchableOpacity>
                </View>
              </View>
              ...
              <View
                ...
                <Text
                  ...
                  {props.route.params.data.status == 1
                    ...
                    ? 'In Progress'
                    : props.route.params.data.status == 3
                    ? 'Esclated To'
                    : props.route.params.data.status == 4
                    ? 'Pending Closure'
                    : props.route.params.data.status == 5
                    ? 'Closed'
                    : '--'}
                </Text>
              </View>
              ...
              {typeof props.route.params.data.justification != 'string' && (
                <>
                  {props.route.params.data.justification.length != 0 && (
                    <>
                      {props.route.params.data.action_required.length != 0 && (
                        <>
                          <View style={{marginTop: wp(3), marginBottom: wp(3)}}>
                            ...
                            <View style={{flexDirection: 'row'}}>
                              <View style={{flexDirection: 'column'}}>
                                {questionAndAnswers.map((d: any, i: number) => (
                                  <View
                                    style={{
                          ...
                          <View style={{marginBottom: wp(2)}}>
                            ...
                            <Text style={{fontSize: wp(3)}}>
                              {
                                props.route.params.data.justification[0]
                                  .keyFindings
                              }
                            </Text>
                          </View>
              ...
              {props.route.params.data.action_required.length != 0 && (
                <>
                  <View style={{marginTop: wp(3), marginBottom: wp(3)}}>
                    ...
                    {props.route.params.data.action_required.map((d, i) => (
                      <Text
                        style={{
                          fontSize: wp(3),
                          fontFamily: fonts.SFuiDisplayMedium,
                ...
                <View>
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {' '}
                      {involvedperson.map((d) => d.name).join(',')}
                    </Text>
                  </View>
                </View>
              </View>

              {attachments.length != 0 && <View style={styles.lineheight} />}
