...
const ViewSOR = (props: ViewSORProps) => {
                      ...
                      <>
                        {isCounterInvolved ? (
                          ...
                          <Text
                            ...
                            <TouchableOpacity
                              onPress={() => {
                                isCounterInvolved(!isCounterInvolved);
                              }}>
                              <Text
                                style={{
                                  marginLeft: wp(1),
 ...
 <Text style={styles.riskttle}>(Severity x Likelihood)</Text>
                  ...
                  <>
                    <View style={[styles.optnselector]}>
                      <TextInput
                        onFocus={() => {
                          setreAssignToArr(
                            searchInSuggestions('', involved_person),
                          );
                        }}
                ...
                <View
                  ...
                  <TextInput
                    onFocus={() => {
                      ...
                      setexclateToArr(searchInSuggestions('', involved_person));
                    }}
                    underlineColorAndroid="transparent"
                    onChangeText={(v: any) => {
                      if (v === '') {
                        ...
                        setexclateToArr(
                          searchInSuggestions(v.toLowerCase(), involved_person),
                        );
                        setesclateTo(v);
                      }
                    }}
      ...
      {SuggestionPop == true && (
        <SuggestionsPop
          suggestedUsers={involved_person}
          onClose={() => {
